...
다음 그림은 레즈 블럭의 도식화이다.
![[Pasted image 20240529143108.png]]
...
실험 결과 훈련 결과와 테스트 오류 둘다 증가하는 현상이 나타났다. ![[스크린샷 2024-05-29 14.33.21.png]][신경망이 깊어지면서 그래디언트 소실이 발생했다고 주장함]
...
![[Pasted image 20240529152549.png]]
...
또한 항등 매핑 경로상에 정보 변경이 발생하면 정확히 항등 매핑이 되지 않는다. 그래서 두번 째 ReLU의 위치를 학습경로로 옮겨 `BN - ReLU - conv - BN - RELU - Conv` 다음 항등 매핑을 진행