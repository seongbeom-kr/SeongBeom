...
> 
>  이런 가정에서 컨볼루션 연산과 풀링 연산이 정의 되었기 때문에 컨볼루션 신경망은 _희소연결(Sparse connectivity)_ 를 갖고 _파라미터 공유(parameter sharing)_ 를 하는 구조를 이루며, 그에 따라 _이동등변성(transiation equivariance)_ 과 위치불변성을 갖는다. 
>  
