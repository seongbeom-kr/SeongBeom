...
- 인터넷이 광범위하게 사용되기 전에 개발되어 보안 취약점이 존재
- 현대 시스템과 인터페이스하는 게 문제가 됨
- 유지보수가 힘든 상태
### Lagacy system management
- 전략을 잘 수립해야함
	- 비즈니스 프로세스를 수정하여 이 시스템이 더이상 필요하지 않도록 조처함
	- 유지보수
	- Re-enginnering을 통해 시스템의 형태를 바꾸어 유지보수정도를 향상시킴
	- 해당 시스템을 새로운 시스템으로 교체함
- 시스템의 품질 및 사업적 가치에 따라 전략이 달라짐