...
### 어텐션을 접목한 인코더 디코더 모델
이 모델은 고정 길이 콘텍스트에 새로운 정보를 순차적으로 추가하기 때문에 성능적 한계를 갖는다. 입력 문장이 길어질수록 고정 길이 콘텍스트에 정보를 다 담지 못하고, 오래전에 입력된 단어를 잘 기억하지 못하는 문제가 생긴다. 콘텍스트벡터를 생성할 때 어텐션을 접목하면 이런 문제를 
