...
❮❮ [[2024-07-19(금)]] | 2024-07-20(토) | [[2024-07-21(일)]] ❯❯
...
## 오늘 작성한 노트 
```dataview 
List FROM "" WHERE file.cday = date("2024-07-20") SORT file.ctime desc 
``` 
## 오늘 수정한 노트 
 ```dataview 
 List FROM "" WHERE file.mday = date("2024-07-20") SORT file.mtime desc 
 ```
 ## 오늘의 요약
>[!summary]
>
